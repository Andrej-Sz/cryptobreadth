...
st.markdown("<h2 style='text-align: center; color: white;'><a href='https://trw-toolbox.streamlit.app/Crypto-Breadth'>This app was moved and will be disabled on 30th November 2024. Click to be redirected to the new app</a></h2>", unsafe_allow_html=True)
